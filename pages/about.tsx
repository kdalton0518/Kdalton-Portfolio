...
export default function About({
  ...
  const parsedLinkedIn: ILinkedinResponse = JSON.parse(JSON.stringify(linkedin));
                ...
                >
                  ...
                  {experience.job_titles.map((job) => (
                    <div key={job.title} className="relative w-full group">
                      ...
                      {job.description && (
                        <div className="whitespace-pre-wrap mt-2 text-sm text-black/80 dark:text-white/50">
